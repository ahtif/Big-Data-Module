...
def main():
	...
	print bank.describe()
	print bank.dtypes
	bank = create_dummies(bank)
	# print "\n\n", bank.describe()
	# print bank.dtypes
	features = select_features(bank)
	clf, X_test, Y_test = log_reg_model(bank)
	print classify_for_threshold(clf, X_test, Y_test, 0.05)
	print classify_for_threshold(clf, X_test, Y_test, 0.1)
	print classify_for_threshold(clf, X_test, Y_test, 0.2)
	gen_roc_curve(clf, X_test, Y_test)
